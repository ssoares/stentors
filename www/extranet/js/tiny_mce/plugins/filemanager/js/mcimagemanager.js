/**
 * $Id: mcimagemanager.js 515 2011-07-11 19:21:32Z ssoares $
 *
 * @author Moxiecode
		...
		openWin : function(f, a) {
			...
			f = t.extend({
				...
				inline : 1
                        ...
                        var lp = t.baseURL.lastIndexOf('/') + 1;

                        if (lp == t.baseURL.length)
                            t.baseURL = t.baseURL.substring(0, t.baseURL.lastIndexOf('/'));
