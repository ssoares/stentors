        ...
        if(isset($this->_tabs[$id])) {
            ...
            foreach($this->_tabs[$id] AS $k => $v) {
                ...
                if(isset($opts['contentUrl'])) {
                    $list .= '<li class="ui-tabs-nav-item"><a id="'.$opts['id'].'" href="'.$opts['contentUrl'].'"><span>'.$v['name'].'</span></a></li>'.PHP_EOL;
                } else {
                    $list .= '<li class="ui-tabs-nav-item"><a id="'.$opts['id'].'" href="#'.$frag_name.'"><span>'.$v['name'].'</span></a></li>'.PHP_EOL;
