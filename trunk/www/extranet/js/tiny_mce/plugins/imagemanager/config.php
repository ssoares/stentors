<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../data/images/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['thumbnail.width'] = "232"; // px
	$mcImageManagerConfig['thumbnail.height'] = "184"; // px
